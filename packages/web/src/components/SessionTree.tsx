...
export function SessionTree({ sessions, activeSessionId, compact = false, actionsEnabled = true, onOpen, onRename, onDelete, onBranch, onInspect }: SessionTreeProps): React.JSX.Element {
