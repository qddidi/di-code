...
interface SettingsOverlayProps {
	...
	readonly onSettingsUpdate: (method: string, params: Record<string, unknown>) => Promise<void>;
	readonly onSettingsRefresh: () => Promise<unknown>;
	readonly onSuccess: (message: string) => void;
	readonly webSlot?: React.ReactNode;
}

const advancedTabs: readonly { id: AdvancedTab; label: string }[] = [
	{ id: "skills", label: "Skills" }, { id: "mcp", label: "MCP" }, { id: "plugins", label: "Plugins" },
	{ id: "presets", label: "Presets" }, { id: "trust", label: "Trust" }, { id: "shortcuts", label: "Shortcuts" },
];

export function SettingsOverlay({ open, settings, onClose, theme, onThemeChange, onSettingsUpdate, onSettingsRefresh, onSuccess, webSlot }: SettingsOverlayProps): React.JSX.Element | null {
